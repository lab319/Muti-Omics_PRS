# KIRC
# case-control status in common samples
# methylation
# lightGBM
# R2: 0.9164573236436553
# -*- coding:utf-8 -*-
import time
import numpy as np
import pandas as pd
...
def data_load(disease, omics, type, random_state):
    ...
    data_cancer_reader = pd.read_csv(
        root + "\\" + disease + "_data\\" + omics + "\\normal\\" + disease + "_" + omics + "_select_" + type + "_control.csv",
    ...
    # E:\PJQ\PRS\PRS_data\KIRC_data\combination\TCGA_KIRC_case_control_model_combination.csv
    data_select = pd.read_csv(root + "\\PRS_data\\" + disease + "_data\\combination\\TCGA_" + disease + "_case_control_model_combination.csv", index_col=0)
...
if __name__ == "__main__":
    ...
    label_prs_df.to_csv("E:\\PJQ\\PRS\\PRS_data\\" + disease + "_data\\" + "TCGA_" + disease + "_" + type + "_control_" + omic + "_lgb_prs.csv")
